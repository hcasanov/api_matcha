...
function init(){
    ...
    database.query("CREATE TABLE IF NOT EXISTS pictures (id SERIAL PRIMARY KEY NOT NULL, account_id SMALLINT, src VARCHAR(255), file_name VARCHAR(100), date_created VARCHAR(100), date_update VARCHAR(100))\;");
