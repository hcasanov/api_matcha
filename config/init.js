...
function init(){
    database.query("CREATE TABLE IF NOT EXISTS accounts (id SERIAL PRIMARY KEY NOT NULL, login VARCHAR(50), name VARCHAR(50) NOT NULL, firstname VARCHAR(50) NOT NULL, mail VARCHAR(50) NOT NULL, passwd VARCHAR(255) NOT NULL, datebirth VARCHAR(100) NOT NULL, age SMALLINT, gender VARCHAR(10), description TEXT, hashtags TEXT, research_perimeter INT default 20, research_age_min SMALLINT, research_age_max SMALLINT, research_gender VARCHAR(10), research_hashtags TEXT, online BOOLEAN, blocked BOOLEAN default false, date_created VARCHAR(100), date_update VARCHAR(100), token VARCHAR(255) default null, confirm BOOLEAN, token_confirm VARCHAR(100))\;");
    database.query("CREATE TABLE IF NOT EXISTS pictures (id SERIAL PRIMARY KEY NOT NULL, id_account SMALLINT, url_picture VARCHAR(255), file_name VARCHAR(100), profile_picture BOOLEAN default false, date_created VARCHAR(100))\;");
